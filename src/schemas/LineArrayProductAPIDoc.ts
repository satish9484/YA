    ...
    paths: {
        "/product/line-array": {
            get: {
                ...
                description: "Retrieve a paginated list of line array products with optional filtering and sorting",
                tags: ["Products"],
                parameters: [
                    {
                        name: "search",
    ...
    components: {
        schemas: {
            LineArrayProduct: {
                type: "object",
                required: [
                    "_id", "name", "image", "price", "description", "category",
                    "categoryId", "categoryName", "inStock", "stockCount",
                    "reviewCount", "tags", "specifications", "brand", "sku", "warranty"
                ],
                properties: {
                    _id: {
                        type: "string",
                    ...
                    description: {
                        ...
                        example: "Precision Sound Control for Challenging Acoustic Spaces with variable dispersion technology"
                    },
                    category: {
                        type: "string",
                        enum: ["Line Array Speakers", "Subwoofers", "Mounting Hardware"],
