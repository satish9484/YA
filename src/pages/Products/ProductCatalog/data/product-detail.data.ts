...
export const productDetailData: ProductDetail = {
    ...
    images: [
        {
            id: 1,
            src: '/adobe/AdobeStock_1399177338_Preview.png',
            alt: 'TOA HX-5B Front View',
            type: 'main',
        },
        {
            id: 2,
            src: '/adobe/AdobeStock_1399177776_Preview.png',
            alt: 'TOA HX-5B Side View',
            type: 'gallery',
        },
        {
            id: 3,
            src: '/adobe/AdobeStock_1149130582_Preview.jpeg',
            alt: 'TOA HX-5B Back View',
            type: 'gallery',
        },
        {
            id: 4,
            src: '/adobe/AdobeStock_1267188545_Preview.jpeg',
    ...
    reviews: [
        {
            ...
            helpful: 23,
            images: ['/adobe/AdobeStock_1399177338_Preview.png'],
        },
        {
            id: 2,
            user: 'AV Installer',
