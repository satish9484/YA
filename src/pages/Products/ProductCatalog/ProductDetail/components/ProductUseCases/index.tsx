...
import styles from './ProductUseCases.module.scss';
...
const ProductUseCases: React.FC<ProductUseCasesProps> = memo(({ applications }) => {
    return (
...
ProductUseCases.displayName = 'ProductUseCases';
