...
const ProductPhotoGallery: React.FC<ProductImageGalleryProps> = memo(
    ({
        images,
        selectedImage,
        onImageSelect,
        ...
        return (
            <div className={styles['modern-image-gallery']} tabIndex={0} onKeyDown={handleKeyDown}>
...
ProductPhotoGallery.displayName = 'ProductPhotoGallery';
